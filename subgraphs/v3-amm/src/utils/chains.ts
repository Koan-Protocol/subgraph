...
export function getSubgraphConfig(): SubgraphConfig {
	...
	if (selectedNetwork == LISK_SEPOLIA_NETWORK_NAME) {
		...
		return {
			factoryAddress: "0x0227628f3F023bb0B980b67D528571c95c6DAC1c", // Example factory address
			stablecoinWrappedNativePoolAddress: "0x...", // Replace with actual USDC/WETH pool address
			stablecoinIsToken0: true, // Adjust based on pool token order
			wrappedNativeAddress: "0x4200000000000000000000000000000000000006", // WETH on Base
			minimumNativeLocked: BigDecimal.fromString("1"), // Adjust based on testnet liquidity
			stablecoinAddresses: [
				"0x036CbD53842c5426634e7929541eC2318f3dCF7e", // Example Base Sepolia USDC
				"0x27eaAf3FD3b508f0E0261F274B2574f15B92c38e", //BASE SEPOLIA DAI
			],
			whitelistTokens: [
